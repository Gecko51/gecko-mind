  ...
  return <section className="pt-20 pb-10 bg-black">
      <div className="container mx-auto px-6">
        <div ref={titleRef} className={`text-center mb-16 transition-all duration-700 ${titleVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-lg max-w-4xl mx-auto leading-relaxed text-foreground">La croissance manuelle a des limites physiques. L'automatisation n'en a aucune.  Transformez vos processus actuels en un moteur capable de gérer 10x plus de volume, sans effort supplémentaire.
          <br />
