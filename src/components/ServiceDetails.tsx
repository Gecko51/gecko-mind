  ...
  return <section className="pt-20 pb-10 bg-black">
      <div className="container mx-auto px-6">
        <div ref={titleRef} className={`text-center mb-16 transition-all duration-700 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-lg max-w-4xl mx-auto leading-relaxed text-foreground">Vous perdez jusqu'à 60% de votre temps sur des tâches sans valeur ajoutée.
Transformons ces heures perdues en opportunités de croissance avec des solutions d'automatisation qui s'adaptent parfaitement à votre métier.<br />Transformons ces heures perdues en opportunités de croissance avec des solutions d'automatisation qui s'adaptent parfaitement à votre métier.</p>
        </div>
