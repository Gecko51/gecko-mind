    ...
    <section id="about" className="py-20 bg-black">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div
            ref={contentRef}
            className={`space-y-8 transition-all duration-700 ${contentVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
          >
            <div>
              ...
              >
                ...
                avec une expertise reconnue sur les Agents IA et les solutions d'intelligence artificielle sur-mesure.
                <br />
                <br />
