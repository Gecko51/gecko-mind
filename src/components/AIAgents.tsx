...
const agents = [
  ...
  },
  {
    ...
    tasks: [
      ...
      "Interface de suivi et de gestion des interactions"
    ]
  }
];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            ...
            <span className="text-white">et Réduisez les Charges de Travail Répétitives de 60 %</span>
          </h2>
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center text-center">
                  {agent.image ? (
                    <img src={agent.image} alt={agent.name} className="w-24 h-24 rounded-full mb-6 object-cover" />
                  ) : (
